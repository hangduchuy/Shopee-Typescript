      ...
      <div className='container'>
          ...
          <div className='min-w-[1000px]'>
            ...
            <div className='my-3 rounded-sm bg-white p-5 shadow'>
              {extendedPurchases?.map((purchase, index) => (
                <div
                  className='grid grid-cols-12 text-center rounded-sm border border-gray-200 mb-5 first:mt-0 py-5 px-4 text-sm text-gray-500'
                  key={purchase._id}
                >
                  <div className='col-span-6'>
                    <div className='flex'>
        ...
        <div className='sticky bottom-0 z-10 mt-8 flex flex-col sm:flex-row sm:items-center rounded-sm bg-white p-5 shadow border border-gray-100'>
          ...
          <div className='sm:ml-auto mt-5 sm:mt-0 flex flex-col sm:flex-row sm:items-center'>
            ...
            <Button className='sm:ml-4 mt-5 sm:mt-0 h-10 w-52 text-center uppercase bg-red-500 text-white text-sm hover:bg-red-600 flex justify-center items-center'>
              Mua hàng
            </Button>
          </div>
        </div>
